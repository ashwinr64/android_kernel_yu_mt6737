...
//caizhifu modified start,mark mtk charging data,and add ours charging data, 2016-10-28
//#include <mt-plat/charging.h>
//#include <mach/mt_charging.h>	
#include "cust_charging.h"
//caizhifu modified end,mark mtk charging data,and add ours charging data, 2016-10-27*/
...
// TINNO BEGIN
// Added by liaoye on Nov. 14, 2016 for add jeita recharge voltage
#ifdef	FEATURE_JEITA_RECHARGE_VOL
static int g_jeita_recharging_voltage = JEITA_RECHARGE_VOLTAGE;
#endif
// TINNO END
#endif
...
static void set_jeita_charging_current(void)
{
	...
	if (BMT_status.charger_type == STANDARD_HOST)
		return;
#endif
//caizhifu modified start for jeita charging, 2016-10-28
		if(g_temp_status == TEMP_POS_45_TO_POS_60){
...
//caizhifu modified end  for jeita charging, 2016-10-28
...
// TINNO BEGIN
// Added by liaoye on Nov. 14, 2016 for bugid:DJJBN-406
#if defined(CONFIG_MTK_JEITA_STANDARD_SUPPORT) && defined(FEATURE_JEITA_CV)
...
// TINNO BEGIN
// Added by liaoye on Nov. 14, 2016 for add jeita recharge voltage
// recharging when battery voltage less than g_jeita_recharging_voltage
#if defined(CONFIG_MTK_JEITA_STANDARD_SUPPORT) && defined(FEATURE_JEITA_RECHARGE_VOL)
