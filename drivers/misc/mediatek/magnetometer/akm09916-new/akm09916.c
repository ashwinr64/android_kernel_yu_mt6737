...
static int AKECS_CheckDevice(void)
{
	...
	/* Check read data */
	if ((buffer[1]<<8|buffer[0]) != AKM09916_DEVICE_ID)
		return -ENXIO;
...
int FST_AK09916(void)
{
	...
	#endif
	/* TEST */
	TEST_DATA(TLIMIT_NO_ASAX_09916, TLIMIT_TN_ASAX_09916, asax, TLIMIT_LO_ASAX_09916,
		TLIMIT_HI_ASAX_09916, &pf_total);
	TEST_DATA(TLIMIT_NO_ASAY_09916, TLIMIT_TN_ASAY_09916, asay, TLIMIT_LO_ASAY_09916,
		TLIMIT_HI_ASAY_09916, &pf_total);
	TEST_DATA(TLIMIT_NO_ASAZ_09916, TLIMIT_TN_ASAZ_09916, asaz, TLIMIT_LO_ASAZ_09916,
		TLIMIT_HI_ASAZ_09916, &pf_total);
