...
static struct LCM_setting_table lcm_initialization_setting_v2[] = 
{
	...
	{0x13,1,{0x00}},
	{0x14,1,{0x00}},
	{0x15,1,{0x10}},// change 20160526
	{0x16,1,{0x00}},
	{0x17,1,{0x01}},// change 20160526
	{0x18,1,{0x00}},
	{0x19,1,{0x00}},
	{0x1a,1,{0x00}},
	{0x1b,1,{0x00}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	#ifdef CONFIG_P4667_PROJECT
	params->dsi.lcm_esd_check_table[1].cmd = 0x50;
	params->dsi.lcm_esd_check_table[1].count = 1;
	params->dsi.lcm_esd_check_table[1].para_list[0] = 0xa7;

	params->dsi.lcm_esd_check_table[2].cmd = 0x51;
	params->dsi.lcm_esd_check_table[2].count = 1;
	params->dsi.lcm_esd_check_table[2].para_list[0] = 0xa7;
	#else
