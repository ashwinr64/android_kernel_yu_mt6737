...
//caizhifu modified end, mark mtk charging data,and add ours charging data, 2016-10-28
...
//caizhifu add start for charger VINDPM set, because charger current is smaller than setting value, 2016-11-04
#ifdef V_VINDPM_SET_VALUE
	bq24296_set_vindpm(0x7);	/* VIN DPM check 4.36V */
#else
