...
#define RG_TYPICAL_s5k5e2ya_liteon    0x0234
#define BG_TYPICAL_s5k5e2ya_liteon		0x01CF
#define R_TYPICAL_s5k5e2ya_liteon		0x0000
#define G_TYPICAL_s5k5e2ya_liteon		0x0000
#define B_TYPICAL_s5k5e2ya_liteon		0x0000

#define S5K5E2YAM_OTP_RG_MAX  0x25D  //0.78 x 1024  = 799
#define S5K5E2YAM_OTP_RG_MIN  0x207  //0.57 x 1024  = 584
#define S5K5E2YAM_OTP_BG_MAX  0x1F7  //0.68 x 1024  = 697
...
uint16_t sunwin_get_otp_module_id(void){
	...
	S5K5E2_write_cmos_sensor(0x0a00, 0x04); //make initial state
	S5K5E2_write_cmos_sensor(0x0a02, 0x05); //page 5,module info part in page 5
	S5K5E2_write_cmos_sensor(0x0a00, 0x01); //otp enable read^M
	mdelay(5);
	temp1 = S5K5E2_read_cmos_sensor(0x0A0A);
	temp2 = S5K5E2_read_cmos_sensor(0x0A0B);
	temp3 = S5K5E2_read_cmos_sensor(0x0A0C);
	otp_flag = temp1 | temp2 | temp3;
	if(otp_flag == 0x00)
	{
		module_id = 0x00;
	}
	else if(otp_flag== 0x01)  // Module info group1
	{
		S5K5E2_write_cmos_sensor(0x0a00, 0x04);
		S5K5E2_write_cmos_sensor(0x0a02, 0x05);
		S5K5E2_write_cmos_sensor(0x0a00, 0x01);
		temp1 = S5K5E2_read_cmos_sensor(0x0A0F);
		temp2 = S5K5E2_read_cmos_sensor(0x0A1F);
		temp3 = S5K5E2_read_cmos_sensor(0x0A2F);
		module_id = temp1 | temp2 | temp3;
	}
	else if(otp_flag == 0x07)  //Module info group2
	{
		S5K5E2_write_cmos_sensor(0x0a00, 0x04);
		S5K5E2_write_cmos_sensor(0x0a02, 0x04);
		S5K5E2_write_cmos_sensor(0x0a00, 0x01);
