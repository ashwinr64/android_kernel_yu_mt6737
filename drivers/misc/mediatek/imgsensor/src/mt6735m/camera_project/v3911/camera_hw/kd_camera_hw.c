...
#define VOL_1000 1000000
	...
	if (On) {
		if((0 == strcmp(currSensorName,"imx135mipiraw"))&&(pinSetIdx != 0)
			||(currSensorName&&(0 == strcmp(currSensorName,"sp2509mipiraw2mp"))&&(pinSetIdx != 1)))
		...
		if ((currSensorName&& (0 == strcmp(SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW, currSensorName))) ||
				(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_S5K5E2YA_SUNWIN_MIPI_RAW, currSensorName))))	
		{
		...
		else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW, currSensorName)))
		{
			...
			||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5675_MIPI_RAW, currSensorName)))
				...
				else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP, currSensorName)))
		{
			...
			PK_DBG("[PowerON] jiangwei enterinto SP2509_CMK\n");
