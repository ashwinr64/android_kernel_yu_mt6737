...
#define PFX "s5k5e2ya_sunwin_camera_sensor"
#define LOG_1 LOG_INF("s5k5e2ya_sunwin,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K5E2YA_SUNWIN_SENSOR_ID,
...
extern struct otp_info_t Sunwin_S5K5E2_OTP; 
extern uint32_t s5k5e2ya_sunwin_liteon_read_otp_info(struct otp_info_t *S5K5E2_OTP);
extern uint32_t s5k5e2ya_sunwin_liteon_update_awb(struct otp_info_t *S5K5E2_OTP);

kal_uint16 S5K5E2_SUNWIN_read_cmos_sensor(kal_uint32 addr)
{
...
void S5K5E2_SUNWIN_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
...
static kal_uint32 open(void)
{
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	//s5k5e2ya_sunwin_liteon_read_otp_info(&Sunwin_S5K5E2_OTP);
	/* initail sequence write in  */
	sensor_init();
    	//s5k5e2ya_sunwin_liteon_update_awb(&Sunwin_S5K5E2_OTP);
	spin_lock(&imgsensor_drv_lock);
...
UINT32 S5K5E2YA_SUNWIN_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
