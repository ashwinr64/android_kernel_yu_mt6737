...
extern bool is_sunwin_camera(void);
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = AR1335_SUNWIN_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 open(void)
{
    ...
    if ((imgsensor_info.sensor_id != (sensor_id +1 ))||(!is_sunwin_camera()))
        return ERROR_SENSOR_CONNECT_FAIL;
    #endif
