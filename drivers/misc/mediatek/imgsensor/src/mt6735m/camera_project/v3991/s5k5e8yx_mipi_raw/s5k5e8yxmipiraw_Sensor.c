...
#if 0
      if(OTP_KEY == 1 || OTP_KEY == 2 || OTP_KEY == 3) //OTP_KEY = 1: do lsc  OTP_KEY = 2:do AWB OTP_KEY = 3:do lsc and AWB
    {
        if(OTP_KEY & 1) 
        {
            S5K5E8_OTP_AUTO_LOAD_LSC();
        }
         if ((OTP_KEY>>1) & 1)
        {
            S5K5E8_sunwin_update_gain();
        }
    }
#else
    S5K5E8_OTP_AUTO_LOAD_LSC();
