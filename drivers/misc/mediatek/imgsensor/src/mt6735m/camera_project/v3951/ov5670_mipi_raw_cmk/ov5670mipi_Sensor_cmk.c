...
static imgsensor_info_struct imgsensor_info = {
	...
	.mclk = 24,//24,//mclk value, suggest 24 or 26 for 24Mhz or 26Mhz==jeff_lin
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0302, 0x68); //;78 MIPI datarate 960 -> 832
...
static kal_uint32 open(void)
{
	...
	sensor_init();
    otp_update_wb_cmk_ov5670(0x127, 0x148);//ZYQ add CMK typical for 3610 front camera
