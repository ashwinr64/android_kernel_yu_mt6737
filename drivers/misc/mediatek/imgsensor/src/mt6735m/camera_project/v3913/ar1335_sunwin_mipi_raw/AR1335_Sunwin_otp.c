...
u16 Sunwin_AR1335_OTP_Data[9] = {0};
...
{
     LOG_INF("TINNO_CAMERA_HAL_DRIVER_LOG.SUNWIN_AR1335.AUTO_LOAD_LSC\n");
    kal_uint16 temp;
//	Select_Type(0x11);
	// enable sc
...
int Sunwin_AR1335_read_OTP(void)
{
    int awb_ck = 0;
    int af_ck = 0;
   ...
   if(af_sum != af_ck){
    ...
    LOG_INF("TINNO_CAMERA_HAL_DRIVER_LOG_2A_OTP_DATA.SUNWIN_AR1335.rg_ratio =%d,bg_ratio=%d,gg_ratio =%d\n",AR1335_otp_Struct.rg_ratio,AR1335_otp_Struct.bg_ratio,AR1335_otp_Struct.gg_ratio);
    LOG_INF("TINNO_CAMERA_HAL_DRIVER_LOG_2A_OTP_DATA.SUNWIN_AR1335.RGr_ratio_Typical =%d,BGr_ratio_Typical=%d,GrGb_ratio_Typical =%d\n",RGr_ratio_Typical,BGr_ratio_Typical,GrGb_ratio_Typical);
    LOG_INF("TINNO_CAMERA_HAL_DRIVER_LOG_2A_OTP_DATA.SUNWIN_AR1335.inf = %d,macro = %d\n",AR1335_otp_Struct.inf,AR1335_otp_Struct.macro);
    Sunwin_AR1335_OTP_Data[0] = AR1335_otp_Struct.module_id;
   Sunwin_AR1335_OTP_Data[1] = AR1335_otp_Struct.rg_ratio;
   Sunwin_AR1335_OTP_Data[2] = AR1335_otp_Struct.bg_ratio;
   Sunwin_AR1335_OTP_Data[3] = AR1335_otp_Struct.gg_ratio;
   Sunwin_AR1335_OTP_Data[4] = RGr_ratio_Typical;
   Sunwin_AR1335_OTP_Data[5] = BGr_ratio_Typical;
   Sunwin_AR1335_OTP_Data[6] = GrGb_ratio_Typical;
   Sunwin_AR1335_OTP_Data[7] = AR1335_otp_Struct.inf;
   Sunwin_AR1335_OTP_Data[8] = AR1335_otp_Struct.macro;
   return 1;
}



void sunwin_otp_test(void)
{
    u8 module_id = 0;
    int rg_ratio = 0,bg_ratio = 0,gg_ratio = 0;
        int macro = 0,inf = 0;
