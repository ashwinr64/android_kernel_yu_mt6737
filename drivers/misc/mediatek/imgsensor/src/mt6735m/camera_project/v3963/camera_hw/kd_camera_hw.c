...
#define VOL_1000 1000000
	...
	if (On) {
		...
		if ((currSensorName && (0 == strcmp(currSensorName, "imx135mipiraw"))) ||
       ...
       else if ((currSensorName&& (0 == strcmp(SENSOR_DRVNAME_AR1335_DARLING_MIPI_RAW, currSensorName)))||(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_AR1335_SUNWIN_MIPI_RAW, currSensorName)))){
            ...
            //IDX_PS_CMPDN:NC
			   ...
			   && (0 == strcmp(SENSOR_DRVNAME_S5K3M2_MIPI_RAW, currSensorName))){
			...
			(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_SUNNY_MIPI_RAW, currSensorName)))||(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_SUNWIN_01_MIPI_RAW, currSensorName))))
		{
			PK_DBG("++++ls.test.SENSOR_DRVNAME_IMX135_SUNWIN_MIPI_RAW.power up");
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
						pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K5E8YX_MIPI_RAW, currSensorName)))
		{
			...
			PK_DBG("[PowerON] jiangwei enterinto S5KE8YX\n");
...
//SubCamera_DVDD_PowerOn();//test
		...
		if ((currSensorName && (0 == strcmp(currSensorName, "imx135mipiraw"))) ||
			...
			(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_SUNNY_MIPI_RAW, currSensorName)))||(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_SUNWIN_MIPI_RAW, currSensorName))))
		{
			ISP_MCLK1_EN(0);
			PK_DBG("++++ls.test.SENSOR_DRVNAME_IMX135_SUNWIN_MIPI_RAW.power down");
			//xshutdown 0
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
				mtkcam_gpio_set(pinSetIdx, CAMRST,
						pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_OFF]);
