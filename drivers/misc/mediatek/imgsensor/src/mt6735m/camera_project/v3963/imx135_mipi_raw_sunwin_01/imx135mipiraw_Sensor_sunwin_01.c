...
#define PFX "IMX135_SUNWIN_01_camera_sensor"
...
extern BYTE sunwin_01_get_otp_module_id(void);
extern BYTE sunwin_01_get_otp_lens_id(void);
#define MIPI_SETTLEDELAY_AUTO     0
#define MIPI_SETTLEDELAY_MANNUAL  1
#define IHDR_USED
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX135_SUNWIN_01_SENSOR_ID,
...
#else
extern bool otp_update_sunwin_01(BYTE update_sensor_otp_awb, BYTE update_sensor_otp_lsc);
extern void otp_clear_flag_sunwin_01(void);
#endif
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
			...
			*sensor_id = *sensor_id -1;
			...
			pr_err("zhanghainan %d\n",*sensor_id);
            if (*sensor_id == imgsensor_info.sensor_id) {//(sunwin_01_get_otp_module_id()==0x06)
		if(sunwin_01_get_otp_module_id()==0x06){
       	     if(sunwin_01_get_otp_lens_id()==0x48){
...
static kal_uint32 close(void)
{
	...
	otp_clear_flag_sunwin_01();//clear otp flag
#endif
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_SENSOR_OTP_AWB_CMD:
            ...
            if(0 != imgsensor.update_sensor_otp_awb || 0 != imgsensor.update_sensor_otp_lsc) {
                otp_update_sunwin_01(imgsensor.update_sensor_otp_awb, imgsensor.update_sensor_otp_lsc);
            }
#endif
            break;
...
UINT32 IMX135_SUNWIN_01_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
