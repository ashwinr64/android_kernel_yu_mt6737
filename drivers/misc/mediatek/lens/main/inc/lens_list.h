...
#endif
#ifdef CONFIG_MTK_LENS_AR1335_DARLING_AF_SUPPORT
#define AR1335_DARLING_AF_SetI2Cclient AR1335_DARLING_AF_SetI2Cclient_Main
#define AR1335_DARLING_AF_Ioctl AR1335_DARLING_AF_Ioctl_Main
#define AR1335_DARLING_AF_Release AR1335_DARLING_AF_Release_Main
extern void AR1335_DARLING_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long AR1335_DARLING_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int AR1335_DARLING_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_AR1335_SUNWIN_AF_SUPPORT
#define AR1335_SUNWIN_AF_SetI2Cclient AR1335_SUNWIN_AF_SetI2Cclient_Main
#define AR1335_SUNWIN_AF_Ioctl AR1335_SUNWIN_AF_Ioctl_Main
#define AR1335_SUNWIN_AF_Release AR1335_SUNWIN_AF_Release_Main
extern void AR1335_SUNWIN_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long AR1335_SUNWIN_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int AR1335_SUNWIN_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_S5K3M2_AF_SUPPORT
#define S5K3M2_AF_SetI2Cclient S5K3M2_AF_SetI2Cclient_Main
#define S5K3M2_AF_Ioctl S5K3M2_AF_Ioctl_Main
#define S5K3M2_AF_Release S5K3M2_AF_Release_Main
extern void S5K3M2_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long S5K3M2_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int S5K3M2_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
