...
#define AF_DRVNAME "S5K4H8_AF_DRV"
...
#if 1                   //add by fangchsh for p4667 4h8 AF voice issue  
...
/* ////////////////////////////////////////////////////////////// */
long S5K4H8_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
*/
//add by fangchsh for p4667 AF voice
static void S5K4H8_AF_CloseDelay(void)
{
...
int S5K4H8_AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
	...
	if (*g_pAF_Opened == 2) {
		...
		//add by fangchsh for p4667 AF voice issue  
        S5K4H8_AF_CloseDelay();
	}
...
void S5K4H8_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
    
#if 1	//add by fangchsh for p4667 AF voice issue  
    int i4RetValue=0;
    char puSendCmd0[2] = {0xec,0xa3};
    char puSendCmd1[2] = {0xa1,0x0d};   // char puSendCmd1[2] = {0xa1,0x05};
    char puSendCmd2[2] = {0xf2,0x48};
