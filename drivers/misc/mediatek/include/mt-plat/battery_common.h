...
//#define SHUTDOWN_SYSTEM_VOLTAGE		(3400)		//caizhifu modified, define it in cust file, 2016-10-28
#endif
...
#define TEMP_FOR_DEVICE_SHUTDOWN	68	//caizhifu add device shut down limit temp, 2016-12-08
//caizhifu modified start,mark mtk charging control data, 2016-12-05
...
//caizhifu modified end,mark mtk charging control data, 2016-12-05
